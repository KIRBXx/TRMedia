...
@section('content')
<h3 class="content-heading">{{ t('Change Avatar') }}</h3>

{{ Form::open(array('url'=>'settings/updateavatar','files'=> TRUE,'role'=>'form')) }}
<div class="form-group">
    {{ Form::file('avatar',array('accept'=>'image/*')) }}
</div>
<div class="form-group">
    {{ Form::submit('Update Avatar',array('class'=>'btn btn-default btn-success')) }}
</div>
{{ Form::close() }}
...
{{ Form::open(array('url' => 'settings/updateprofile')) }}
<div class="form-group">
    <label for="username">{{ t('Username') }}
        <small>( Username can not be changed )</small>
    </label>
...
<div class="form-group">
    ...
    {{ Form::text('dob',$user->dob,array('class'=>'form-control','id'=>'dp1')) }}
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    {{ Form::text('fbLink',$user->fb_link,array('class'=>'form-control')) }}
</div>
...
<div class="form-group">
    ...
    {{ Form::text('twLink',$user->tw_link,array('class'=>'form-control')) }}
</div>


<div class="form-group">
    <label for="blogurl">Website url
        <small>( Your Website url )</small>
    </label>
    {{ Form::text('blogurl',$user->blogurl,array('class'=>'form-control')) }}
</div>

{{ Form::submit('Update',array('class'=>'btn btn-default btn-success')) }}
...
<div class="page-header">
    <h3 class="content-heading">{{ t('Change Password') }}</h3>
</div>


{{ Form::open(array('url'=>'settings/changepassword')) }}
<div class="form-group">
...
<div class="form-group">
    {{ Form::submit('Change Password',array('class'=>'btn btn-default btn-success')) }}
</div>
